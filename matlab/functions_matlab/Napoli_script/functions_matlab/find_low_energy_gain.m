function [slopes_and_interceptes] = find_low_energy_gain(transfer_function_mean_values, statistic_used, folder_name)
%% INPUT
...
if ~exist([folder_name 'analysis_matlab\'],'dir' )
    mkdir([folder_name 'analysis_matlab\']);
end

fileID = fopen([folder_name 'analysis_matlab\Low_Energy_Gain.dat'],'w');
